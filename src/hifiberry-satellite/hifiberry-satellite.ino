...
void setup(void)
{
  ...
  //Serial.println("Starting Rotary Satellite...");
   ...
   // Initialize configuration manager
    ...
    String apiUrl = configManager.getHbApiUrl();
    ...
    // Initialize WiFi (disconnect any previous connection)
